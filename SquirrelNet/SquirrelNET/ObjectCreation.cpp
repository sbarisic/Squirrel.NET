...
namespace SquirrelNET {
	...
	SQRESULT Sq::SetNativeClosureName(IntPtr v, SQInteger idx, String^ name) {
		GetSQCharPtr(name, namePtr);
		return sq_setnativeclosurename(ToVM(v), idx, namePtr);
	}
